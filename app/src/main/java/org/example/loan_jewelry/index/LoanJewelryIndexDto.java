...
public class LoanJewelryIndexDto extends Dto {
    private int id; //LoanJewelryObject
    private double amount;//LoanJewelryObject
    private String weight; //JewelryObject
    private String caratage; //JewelryObject
    private String description; //JewelryObject

    public LoanJewelryIndexDto(int id, double amount, String weight, String caratage, String description){
